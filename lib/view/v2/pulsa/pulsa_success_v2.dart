...
class PulsaSuccessV2View extends StatelessWidget {
  const PulsaSuccessV2View({super.key});
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          _PulsaDetailSuccess(DateTime.now())));
            },
            child: Text(
              'Cek Transaksi',
...
class _PulsaDetailSuccess extends StatelessWidget {
  final DateTime dateTime;
  const _PulsaDetailSuccess(this.dateTime);
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              'Pulsa ${pulsa.selectPulsaData?.name.toString() ?? ""}',
