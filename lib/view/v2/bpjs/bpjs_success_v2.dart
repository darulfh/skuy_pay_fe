...
class BpjsSuccessV2View extends StatelessWidget {
  const BpjsSuccessV2View({super.key});
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          _BpjsDetailSuccess(DateTime.now())));
            },
            child: Text(
              'Cek Transaksi',
...
class _BpjsDetailSuccess extends StatelessWidget {
  final DateTime dateTime;
  const _BpjsDetailSuccess(this.dateTime);
