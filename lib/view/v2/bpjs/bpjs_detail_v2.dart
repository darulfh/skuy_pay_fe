...
import 'package:capstone_flutter/view/v2/bpjs/bpjs_method_payment_v2.dart';
import 'package:capstone_flutter/view_model/bpjs_provider/bpjs_provider.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class BpjsDetailV2View extends StatefulWidget {
  const BpjsDetailV2View({super.key});

  @override
  State<BpjsDetailV2View> createState() => _BpjsDetailV2ViewState();
}

class _BpjsDetailV2ViewState extends State<BpjsDetailV2View> {
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const BpjsMethodPaymentV2View()));
            },
            child: Text(
              'Lanjutkan',
              style: whiteFont14.copyWith(color: Colors.white),
...
class BpjsDetailCard extends StatelessWidget {
  final bool isSuccess;
  const BpjsDetailCard({super.key, this.isSuccess = false});

  @override
  Widget build(BuildContext context) {
    final bpjs = context.watch<BpjsProvider>().bpjs;
    if (bpjs == null) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _Tag(
            title: 'Periode',
            value: bpjs.period.intToMonth(),
          ),
          _Tag(
            title: 'Harga',
            value: bpjs.nominal.toString().toPrice(),
          ),
          _Tag(
            title: 'Harga',
            value: "2500".toPrice(),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 15),
                    child: Text(
                      (bpjs.nominal + bpjs.admin).toString().toPrice(),
                      style: blackFont12.copyWith(fontWeight: FontWeight.bold),
                    ),
                  ),
                ],
