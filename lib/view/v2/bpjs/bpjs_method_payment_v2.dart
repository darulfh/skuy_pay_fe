...
import 'package:capstone_flutter/view/v2/bpjs/bpjs_pin_v2.dart';
...
class BpjsMethodPaymentV2View extends StatelessWidget {
  const BpjsMethodPaymentV2View({super.key});
            ...
            Row(
              ...
              children: [
                ...
                Radio(
                  ...
                  groupValue: bpjs.selectedRadio,
                  onChanged: (value) {
                    context.read<BpjsProvider>().changeRadio(value);
                  },
                ),
              ],
            ),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  bpjs.bpjs?.price.toString().toPrice() ?? "",
                  style: blackFont12.copyWith(fontWeight: FontWeight.w400),
                ),
              ],
            ),
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            ...
            if (user.balance.round() - (bpjs.bpjs?.price ?? 0) < 0) {
              Fluttertoast.showToast(
            ...
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => const BpjsPinV2View()));
          },
          child: Text(
            'Yuk Bayar!',
