...
class TokenListrikSuccessV2View extends StatelessWidget {
  const TokenListrikSuccessV2View({super.key});
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          _TokenListrikDetailSuccess(DateTime.now())));
            },
            child: Text(
              'Cek Transaksi',
...
class _TokenListrikDetailSuccess extends StatelessWidget {
  final DateTime dateTime;
  const _TokenListrikDetailSuccess(this.dateTime);
