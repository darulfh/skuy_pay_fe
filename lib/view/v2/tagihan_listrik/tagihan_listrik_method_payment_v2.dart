...
import 'package:capstone_flutter/view/v2/tagihan_listrik/tagihan_listrik_pin_v2.dart';
...
class TagihanListrikMethodPaymentV2View extends StatelessWidget {
  const TagihanListrikMethodPaymentV2View({super.key});
            ...
            Row(
              ...
              children: [
                ...
                Radio(
                  ...
                  onChanged: (value) {
                    context.read<TagihanListrikProvider>().changeRadio(value);
                  },
                ),
              ],
            ),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  (listrik.tagihanListrikInquiry?.price.toString().toPrice()) ??
                      "",
                  style: blackFont12.copyWith(fontWeight: FontWeight.w400),
                ),
              ],
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            ...
            if (user.balance.round() -
                    (listrik.tagihanListrikInquiry?.price ?? 0) <
                0) {
              Fluttertoast.showToast(
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const TagihanListrikPinV2View()));
          },
          child: Text(
            'Yuk Bayar!',
