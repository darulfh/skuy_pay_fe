...
import 'package:capstone_flutter/view/v2/paket_data/paket_data_metode_pembayaran_v2.dart';
...
class PaketDataDetailPembayaranV2View extends StatelessWidget {
  const PaketDataDetailPembayaranV2View({super.key});
      ...
      bottomNavigationBar: PulsaBottomBar(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const PaketDataMetodePembayaranV2View(),
            ),
          );
        },
      ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      'Pulsa ${value.selectPaketData?.name ?? ""}',
                      // 'Pulsa 5000',
                      style: blackFont12.copyWith(fontWeight: FontWeight.w400),
                    ),
                  ],
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      'Rp. ${NumberFormat('#,###', 'id_ID').format(value.selectPaketData?.price.toInt())}',
                      // 'Rp 6.500',
                      style: blackFont12.copyWith(fontWeight: FontWeight.w400),
                    ),
                  ],
