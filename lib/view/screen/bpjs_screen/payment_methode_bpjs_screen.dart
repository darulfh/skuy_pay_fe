...
class PaymentMethodBpjs extends StatefulWidget {
  const PaymentMethodBpjs({super.key});

  @override
  State<PaymentMethodBpjs> createState() => _PaymentMethodBpjsState();
}

class _PaymentMethodBpjsState extends State<PaymentMethodBpjs> {
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const PinScreenBpjs()));
            },
            child: Text(
              'Yuk Bayar!',
              style: whiteFont14,
