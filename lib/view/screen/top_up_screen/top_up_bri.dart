...
class TopUpBri extends StatefulWidget {
  final String bankCode;
  const TopUpBri({super.key, required this.bankCode});

  @override
  State<TopUpBri> createState() => _TopUpBriState();
}

class _TopUpBriState extends State<TopUpBri> {
...
List<Item> generateItems() {
  return <Item>[
    ...
    Item(
      headerValue: 'm-BRI (BRI Mobile)',
      expandedValue: '1. Masuk ke akun m-banking.\n'
          '2. Pilih menu m-Transfer > BRI virtual akun.\n'
