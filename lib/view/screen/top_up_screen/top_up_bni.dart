...
class TopUpBni extends StatefulWidget {
  final String bankCode;
  const TopUpBni({super.key, required this.bankCode});

  @override
  State<TopUpBni> createState() => _TopUpBniState();
}

class _TopUpBniState extends State<TopUpBni> {
...
List<Item> generateItems() {
  return <Item>[
    ...
    Item(
      headerValue: 'm-BNI (BNI Mobile)',
      expandedValue: '1. Masuk ke akun m-banking.\n'
          '2. Pilih menu m-Transfer > BNI virtual akun.\n'
