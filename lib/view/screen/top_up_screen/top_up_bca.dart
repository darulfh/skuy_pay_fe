...
class TopUpBca extends StatefulWidget {
  final String bankCode;
  const TopUpBca({super.key, required this.bankCode});

  @override
  State<TopUpBca> createState() => _TopUpBcaState();
}

class _TopUpBcaState extends State<TopUpBca> {
